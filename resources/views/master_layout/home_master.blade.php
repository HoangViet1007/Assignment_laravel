...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('public_clien/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}">
...
<body>
    ...
    <!-- ========== HEADER ========== -->
    <header id="header" class="u-header u-header-left-aligned-nav header">
        <div class="u-header__section">
                ...
                <div class="container">
                    <div class="d-flex align-items-center">
                        <div class="topbar-left">
                            <marquee behavior="" direction=""><a href="#" class=" font-size-13 hover-on-dark"
                                    style="color:#fed700;">Chào mừng bạn đến với hệ thống thương mại điện tử của chúng
                                    tôi</a></marquee>
                        </div>
            ...
            <div class="py-2 py-xl-5 bg-primary-down-lg">
                <div class="container my-0dot5 my-xl-0">
                    <div class="row align-items-center">
                                            ...
                                            <div class="js-scrollbar u-sidebar__body">
                                                <div id="headerSidebarContent"
                                                    ...
                                                    <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                        ...
                                                        <li class="">
                                                            <a class="u-header-collapse__nav-link font-weight-bold"
                                                                href="#">Top 100 sản phẩm đang sale</a>
                                                        </li>
                                                        <!-- End Top 100 Offers -->
                                                        <!-- End New Arrivals -->
                                                        @foreach ($category_parent as $cate)
                                                            <li class="u-has-submenu u-header-collapse__submenu">
                                                                <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer"
                                                                    href="javascipt:;"
                                                                    data-target="#{{ $cate->slug }}" role="button"
                                                                    data-toggle="collapse" aria-expanded="false"
                                                                    aria-controls="{{ $cate->slug }}">
                                                                    {{ $cate->name }}
                                                                </a>

                                                                <div id="{{ $cate->slug }}" class="collapse"
                        ...
                        <!-- Search Bar -->
                        <div class="col d-none d-xl-block" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
                            <form class="js-focus-state" action="{{route('search2.sanpham')}}" method="post"
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <select
                                            ...
                                            @foreach ($category_table_product as $a)
                                                <option value="{{ $a->id_categories }}">{{$a->name_cate}}</option>
                                            @endforeach
                                        </select>
                                        <!-- End Select -->
                                                ...
                                                <a href="//clickbuy.com.vn/ipad-9-7-2017-gen-5-32gb-4g-wifi-cu-99">
                                                    <div class="row">
                                                        <div class="col-md-1 mr-3">
                                                            <p><img src="//clickbuy.com.vn/uploads/2019/04/apple-ipad-9.7-2018-vang.png" alt="" style="width:50px;height:50px;float-left;"></p>
                                                        </div>
                                                        <div class="col-md-10">
                                                            <h3 class="text-black font-size-15">iPad 9.7 2017 - Gen 5- 32Gb (4G + wifi) cũ 99%</h3>
                                                            <p class="ex_sprice text-danger" style="margin-top:-10px;">6.490.000₫</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                   ...
                                   {{-- <li class="col d-xl-none px-2 px-sm-3 position-static">
                                    ...
                                    <li class="col pr-xl-0 px-2 px-sm-3 d-none d-xl-block">
                                        <div id="basicDropdownHoverInvoker"
                                            class="text-gray-90 position-relative d-flex price_in_cart"
                                            data-toggle="tooltip" data-placement="top" title="Cart"
                                            aria-controls="basicDropdownHover" aria-haspopup="true"
                                            aria-expanded="false" data-unfold-event="click"
                                            data-unfold-target="#basicDropdownHover" style="cursor:pointer;"
                                        ...
                                        <div id="basicDropdownHover"
                                            ...
                                            <ul class="list-unstyled px-3 pt-3 ul_list_cart">
                                                                ...
                                                                <ul class="list-unstyled row mx-n2">
                                                                    ...
                                                                    <li class="px-2 col">
                                                                        <h5
                                                                            ...
                                                                            <a
                                                                                href="{{ route('product_detail', ['slug' => $a['slug'], 'id' => $a['id']]) }}">{{ $a['name'] }}</a>
                                                                        </h5>
                                                                        <span class="font-size-14">{{ $a['quantity'] }}
                                                                            × {{ number_format($a['price']) }}</span>
                                                                    </li>
                                                                    <li class="px-2 col-auto">
                                                ...
                                                <li class="text-center">
                                                    <a href="javacript:;" class="text-center">Xem chi tiết hãy vào xem
                                                        giỏ hàng</a>
                                                </li>
                                            </ul>
                                            <div class="flex-center-between px-4 pt-2">
                                                <a href="{{ route('card') }}"
                                                    class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5">Xem
                                                    giỏ</a>
                                                <a href="{{ route('getcheckout') }}"
                                                    class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5">Thanh
                                                    toán</a>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="d-none d-xl-block container" style="z-index:-1;">
                <div class="row">
                    <!-- Vertical Menu -->
                                                            ...
                                                            @foreach ($category_parent as $cate)
                                                                <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                    ...
                                                                    <a id="basicMegaMenu"
                                                                        ...
                                                                        aria-expanded="false">{{ $cate->name }}</a>
                                                                    <!-- Nav Item - Mega Menu -->
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                        style="border:2px solid #fed700;border-radius:5px;height:350px;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;"
                                                                        aria-labelledby="basicMegaMenu">
                                                                        <div class="vmm-bg">
                                                                            <img class="img-fluid"
                                                                                src="{{ asset('public_clien/img/500X400/img1.png') }}"
                                                                            ...
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                <a href="javascript:;"
                                                                                    style="text-decoration:none;"><span
                                                                                        class="u-header__sub-menu-title">{{ $cate->name }}</span></a>
                                                        ...
                                                        <ul class="navbar-nav u-header__navbar-nav">
                                                            ...
                                                            @foreach ($category_parent as $cate)
                                                                <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                    ...
                                                                    <a id="basicMegaMenu"
                                                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                                        href="{{ route('product_clien_cate', [$cate->slug, $cate->id]) }}"
                                                                        aria-haspopup="true"
                                                                        aria-expanded="false">{{ $cate->name }}</a>
                                                                    <!-- Nav Item - Mega Menu -->
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                        ...
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                <span
                                                                                    class="u-header__sub-menu-title">{{ $cate->name }}</span>
                                                                                @include('master_layout.child_menu_sidebar',['cate'=>$cate])
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                <ul class="navbar-nav u-header__navbar-nav">
                                    ...
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link @if ($routeName=Route::currentRouteName()=='home' ) {{ 'text-sale' }} @endif"
                                            href="{{ route('home') }}" aria-haspopup="true" aria-expanded="false"
                                            aria-labelledby="pagesSubMenu">Trang chủ</a>
                                    </li>
                                    <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="change"
                                        data-animation-in="slideInUp" data-animation-out="fadeOut" data-position="left">
                                        <a id="homeMegaMenu"
                                            class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                            href="{{ route('product_clien') }}" aria-haspopup="true"
                                        ...
                                        <div class="hs-mega-menu w-100 u-header__sub-menu"
                                            aria-labelledby="homeMegaMenu" style="display:none;">
                                            <div class="row u-header__mega-menu-wrapper">
                                                @foreach ($category_parent as $a)
                                                    <?php $space = ''; ?>
                                                    <div class="col-md-3">
                                                        <a href="javascript:;"><span
                                                                class="u-header__sub-menu-title">{{ $a->name }}</span></a>
                                    ...
                                    <!-- Featured Brands -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link @if ($routeName=Route::currentRouteName()=='blog' ||
                                            ($routeName=Route::currentRouteName()=='blogDetail' )) {{ 'text-sale' }} @endif"
                                            href="{{ route('blog') }}" aria-haspopup="true" aria-expanded="false"
                                            aria-labelledby="pagesSubMenu">Tin tức</a>
                                    </li>
                                    <!-- End Featured Brands -->

                                    <!-- Trending Styles -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link @if ($routeName=Route::currentRouteName()=='contact' ) {{ 'text-sale' }} @endif"
                                            href="{{ route('contact') }}" aria-haspopup="true" aria-expanded="false"
                                            aria-labelledby="blogSubMenu">Liên hệ</a>
                                    </li>
                                    <!-- End Trending Styles -->
                                    ...
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#" aria-haspopup="true"
                                            aria-expanded="false">Chỉnh sách bảo hành</a>
                                    </li>

                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="#" aria-haspopup="true"
                                            aria-expanded="false">Sửa chữa</a>
                                    </li>
                                    <!-- End Gift Cards -->
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col pl-3">
                                    ...
                                    <a href="tel:+80080018588"
                                        class="font-size-20 text-gray-90">{{ $websetting->phone }} </a><a
                                        href="tel:+0600874548" class="font-size-20 text-gray-90">- 0827541636</a>
                                </div>
                            </div>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-12 col-md mb-4 mb-md-0">
                                ...
                                <ul
                                    ...
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Mua hàng & Trả
                                            góp</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Đặt hàng & Thanh
                                            toán</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Chính sách & Bảo
                                            mật</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Huỷ hàng & Đổi
                                            trả</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Điều khoản mua
                                            hàng</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Tra cứu đơn hàng</a>
                                    </li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Chính sách giải
                            ...
                            <div class="col-12 col-md mb-4 mb-md-0">
                                ...
                                <ul
                                    class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Bán hàng online</a>
                                    </li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Chăm sóc khách
                                            hàng</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Hỗ trợ kĩ thuật</a>
                                    </li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Bảo hành và sửa
                                            chữa</a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/product-categories-5-column-sidebar.html">Liên hệ khối văn
                                            phòng</a></li>
                                </ul>
                                <!-- End List Group -->
                            </div>
                            ...
                            <div class="col-12 col-md mb-4 mb-md-0">
                                ...
                                <ul
                                    class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/my-account.html">Hot lile bán hàng : <span
                                                style="font-weight: bold;">0355.755.697</span></a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/track-your-order.html">Hỗ trợ bảo hành kĩ thuật : <span
                                                style="font-weight:bold;">1900.211.311</span></a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="../shop/wishlist.html">Hot line hỗ trợ phần mền : <span
                                                style="font-weight: bold;"> 082.754.1636</span></a></li>
                                    <li><a class="list-group-item list-group-item-action"
                                            href="terms-and-conditions.html">Hot line phản ảnh chất lượng phục vụ :
                                            <span style="font-weight: bold;">1900.111.222</span> </a></li>
                                </ul>
                                <!-- End List Group -->
                            </div>
                        </div>
                ...
                <div class="flex-center-between d-block d-md-flex">
                    ...
                    <div class="text-md-right">
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5" src="{{ asset('public_clien/img/100X60/img1.jpg') }}"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5" src="{{ asset('public_clien/img/100X60/img2.jpg') }}"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5" src="{{ asset('public_clien/img/100X60/img3.jpg') }}"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5" src="{{ asset('public_clien/img/100X60/img4.jpg') }}"
                                alt="Image Description">
                        </span>
                        <span class="d-inline-block bg-white border rounded p-1">
                            <img class="max-width-5" src="{{ asset('public_clien/img/100X60/img5.jpg') }}"
                                alt="Image Description">
                        </span>
                    </div>
                </div>
    ...
    @if(Auth::check())
        <aside id="sidebarContent2" class="u-sidebar u-sidebar__lg" aria-labelledby="sidebarNavToggler2">
            <div class="u-sidebar__scroller">
                <div class="u-sidebar__container">
                    <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                        <!-- Toggle Button -->
                        <div class="d-flex align-items-center pt-4 px-7 button-exit">
                            <button type="button" class="close ml-auto"
                    ...
                    <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                        ...
                        <div class="js-scrollbar u-sidebar__body">
                            <div class="u-sidebar__content u-header-sidebar__content">
                                {{-- form đăng nhập --}}
                                <form action="{{route('post.LoginClien')}}" class="js-validate" id="login_form" method="POST">
                                            ...
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" id="email_login"
                                                        ...
                                                        aria-describedby="LoginEmailLabel" data-msg="Email không hợp lệ"
                                            ...
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control" name="password"
                                                        ...
                                                        data-msg="Mật khẩu không hợp lệ" data-error-class="u-has-error"
                                ...
                                <form action="" class="js-validate mt-5">
                                    <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                                            ...
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" id="recoverEmail"
                                                        placeholder="Email" aria-label="Your email"
                                                        aria-describedby="recoverEmailLabel" required
                                                        data-msg="Email không hợp lệ" data-error-class="u-has-error"
                                        ...
                                        <div class="mb-2">
                                            <button type="submit"
                                                class="btn btn-block btn-sm btn-primary transition-3d-hover">Gửi</button>
                                        </div>
    ...
    <script src="{{ asset('public_clien/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}">
    </script>
    ...
    <script>
        $('document').ready(function() {
            $('#search_name').on('keyup', function(e) {
                ...
                let url_sp_detail = '{!! route('product_detail',['slug'=>'Slug','id'=>'Id']) !!}' ;
                let url_image = "{{ url('') }}" ;
                let url = '{!!route('search.sanpham')!!}' ;
                if(keyword.length > 2){
                    $.ajax({
                        type: 'GET',
                        url: url,
                            ...
                            if(data.code == 200){
                                ...
                                $('.search_home').show() ;
                                    for(var item in data.data){
                                        url_sp_detail = url_sp_detail.replace('Slug',data.data[item]['slug_product']) ;
                                        url_sp_detail = url_sp_detail.replace('Id',data.data[item]['id_product']) ;
                                html += `<li style="list-style:none;" class="li_search">
                                            <a href="${url_sp_detail}">
                                                <div class="row">
                                                    <div class="col-md-1 mr-3">
                                                        <p><img src="${url_image}${data.data[item]['image']}" alt="" style="width:50px;height:50px;float-left;"></p>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <h3 class="text-black font-size-15">${data.data[item]['name_product']}</h3>
                                                        <p class="ex_sprice text-danger" style="margin-top:-10px;">${data.data[item]['price'].toLocaleString('vi', {style: 'currency',currency: 'VND'})}</p>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>`
                                }
                              return $('.ul_search').html(html) ;
                            }
                        },
                        error: function(data) {
