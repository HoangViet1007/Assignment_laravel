                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Danh mục sản phẩm</li>
                        </ol>
                    </nav>
                </div>
                <!-- End breadcrumb -->
            ...
            <div class="row mb-8">
                ...
                <div class="col-xl-9 col-wd-9gdot5">
                    ...
                    <div class="flex-center-between mb-3">
                        <h3 class="font-size-25 mb-0">{{ucfirst($name_cate)}}</h3>
                    </div>
                                    ...
                                    <div class="product-item__outer w-100">
                                        <div class="product-item__inner remove-prodcut-hover py-4 row">
                                            ...
                                            <div class="product-item__body col-6 col-md-7">
                                                <div class="pr-lg-10">
                                                    <div class="mb-2"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">{{$b->category->name}}</a></div>
                                                    <h5 class="mb-2 product-item__title"><a href="{{route('product_detail',['slug'=>$b->slug,'id'=>$b->id])}}" class="text-blue font-weight-bold">{{$b->name}}</a></h5>
                                                    <div class="prodcut-price d-md-none">
                                                        <div class="text-gray-100">{{number_format(($b->price) + ($b->price * $b->sale/100))}}  <u>đ</u></div>
                                                    </div>
                                            ...
                                            <div class="product-item__footer col-md-3 d-md-block">
                                                <div class="mb-2 flex-center-between">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100" style="color:red;">{{number_format(($b->price) + ($b->price * $b->sale/100))}}  <u>đ</u></div>
                                                    </div>
