...
@section('title', 'Chỉnh sửa option cho sản phẩm')
@section('main_admin')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <!-- form start -->
                    <form method="POST" action="{{ route('product_option.update',$data->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="is_main" id="is_main" class="form-control">
                                            ...
                                            <option value="0" @if($data->is_main == 0 ) {{'selected'}} @endif>False</option>
                                            <option value="1" @if($data->is_main == 1 ) {{'selected'}} @endif>True</option>
                                        </select>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('product_option.index_id',$data->product_id) }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
