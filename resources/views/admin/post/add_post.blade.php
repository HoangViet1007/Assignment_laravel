                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_posts_id" id="category_posts_id" class="form-control @error('category_posts_id') is-invalid @enderror">
                                        <option value=""> -- Cate post -- </option>
                                        @foreach ($cate_post as $a)
                                            <option value="{{$a->id}}" {{ (collect(old('category_posts_id'))->contains($a->id)) ? 'selected':'' }}>{{$a->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for=""><b></b></label>
                                    <img src="{{asset('imageDefault.png')}}" alt="" class="img-responsive" id="ig" width="100%" height="160px" style="margin-top:-30px">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description" id="short_description" cols="30" rows="10" placeholder="Short Description..." class="form-control">{{old('short_description')}}</textarea>
