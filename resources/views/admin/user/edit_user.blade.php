                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control @error('gender') is-invalid @enderror">
                                            <input type="radio" name="gender" value="0" @if ($model->gender == 0) {{ 'checked' }} @endif> Nữ &ensp;&ensp;
                                            <input type="radio" name="gender" value="1" @if ($model->gender == 1) {{ 'checked' }} @endif> Nam
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" type="text" name="image" readonly
                                    ...
                                    <div class="form-group">
                                        <label for=""><b></b></label>
                                        <img src="{{ url('') }}{{$model->image}}" alt="" class="img-responsive" id="ig"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="roles[]" id="roles" multiple="multiple"
                                            ...
                                            @foreach($role as $a)
                                            <option
                                            {{$roleOfUser->contains('id',$a->id) ? 'selected' : ''}}
