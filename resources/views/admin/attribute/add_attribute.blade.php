        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <!-- form start -->
                    <form method="POST" action="{{ route('attribute.post-create') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Slug..." class="form-control" id="slug" name="slug"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Value..." name="value" id="value"
                                            class="form-control" readonly value="{{ old('value') }}">
                                        @if ($errors->has('value'))
