                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Tên quyền..." class="form-control" name="name" value="{{ $data->name }}">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="key code..." class="form-control" name="key_code"value="{{$data->key_code}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Mô tả..." class="form-control" name="display_name" value="{{$data->display_name}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" id="" class="form-control">
                                        ...
                                        @foreach($permission_parent as $a)
                                            <option value="{{$a->id}}" @if($data->parent_id == $a->id) ? {{'selected'}} : {{''}} @endif>{{$a->name}}</option>
                                        @endforeach
                                    </select>
