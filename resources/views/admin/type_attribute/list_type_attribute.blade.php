...
@section('title','Danh sách loại thuộc tính')
@section('main_admin')
<div class="container">
        ...
        <div class="col-sm-12">
            <div class="row d-flex justify-content-center align-items-center">
                <form method="POST" id="search-form" class="form-inline d-flex justify-content-center align-items-center" role="form" style="margin-bottom: 15px;">
                    ...
                    <a href="{{route('type_attribute.index')}}" class="btn btn-danger ml-2">Cancel</a>
                </form>
            </div>
            <!-- form  -->
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width:140px;">
                            <a href="{{route('type_attribute.create')}}" class="btn btn-danger"><i class="fas fa-plus"></i></a>  
                        </th>
                    </tr>
                </thead>
...
<script>
    $(function() {
        var oTable = $('#category-table').removeAttr('width').DataTable({
            ...
            ajax: {
                url: '{!! route("type_attribute.anyData") !!}',
                data: function(d) {
            ...
            columns: [{
                ...
                // },
                {
                    ...
                    render: (data, type, full, meta) => {
                           // url edit
                           let url_edit = '{!! route('type_attribute.edit',['type_attribute'=>'id_type_attribute']) !!}' ;
                            url_edit = url_edit.replace('id_type_attribute',data) ;
                            // url delete
                            let url_delete = '{!! route('type_attribute.destroy',['type_attribute'=>'id_type_attribute']) !!}' ;
                            url_delete = url_delete.replace('id_type_attribute',data) ;
