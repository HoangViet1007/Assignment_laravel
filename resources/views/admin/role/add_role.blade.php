                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Mô tả..." class="form-control" id="display_name" name="display_name" value="{{old('display_name')}}">
                                ...
                                <div class="card border-primary mb-3 col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card-body text-primary col-md-3">
                                            <h5 class="card-title">
                                                <input type="checkbox" value="{{$b->id}}" name="permission_id[]" class="checkbox_childrent"> {{$b->name}}
                                            </h5>
                                        </div>
                                        @endforeach
                                    </div>
