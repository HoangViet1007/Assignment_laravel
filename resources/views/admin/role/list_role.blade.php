        ...
        <div class="col-sm-12">
            <div class="row d-flex justify-content-center align-items-center">
                <form method="POST" id="search-form" class="form-inline d-flex justify-content-center align-items-center" role="form" style="margin-bottom: 15px;">
                    ...
                    <div class="form-group mr-2">
                        <input type="text" class="form-control" name="display_name" id="name" placeholder="Mô tả..." style="border-radius:0%;width:250px;">
                    </div>
                    ...
                    <a href="{{route('role.index')}}" class="btn btn-danger ml-2">Cancel</a>
                </form>
            </div>
            <!-- form  -->
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width:140px;">
                            <a href="{{route('role.create')}}" class="btn btn-danger"><i class="fas fa-plus"></i></a>  
                        </th>
                    </tr>
                </thead>
            ...
            columns: [{
                ...
                // },
                {
                    ...
                    render: (data, type, full, meta) => {
                        // url edit
                        let url_edit = '{!! route('role.edit',['role'=>'id_role']) !!}' ;
                        url_edit = url_edit.replace('id_role',data) ;
                        // url delete
                        let url_delete = '{!! route('role.destroy',['role'=>'id_role']) !!}' ;
                        url_delete = url_delete.replace('id_role',data) ;
                        return `
