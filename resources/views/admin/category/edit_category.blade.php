                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Slug..." class="form-control" id="slug" name="slug" value="{{$model->slug}}" readonly>
                                    @if($errors->has('slug'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for=""><b>Trang thái</b><span class="text-danger ml-1">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" name="parent_id" class="form-control" id="parent_id">
